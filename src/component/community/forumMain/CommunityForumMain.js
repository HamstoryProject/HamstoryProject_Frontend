...
// component import
import PostList from "../../post/freeForum/list/PostList";
import Loading from "../../etc/loading/Loading";
import Header from '../../header/main/absolute/Header';
import CommunityHeader from '../../header/main/community/CommunityHeader';
import CommunityFreeForum from '../freeForum/CommunityFreeForum';
import Footer from '../../footer/Footer';

// css import
import styles from './CommunityForumMain.module.css';

export default function CommunityForumMain(){
    ...
    return(
        <div className={styles.body}>
            ...
            <main className={styles.main}>
                ...
                <section>
                    {loading ? <Loading/> : <CommunityFreeForum elements = {elements} renderPostList = {renderPostList} posts = {res}/>}
                </section>
            </main>
